...
* Visualizer Viewer: enables a user to view the graph of an application network, but does not allow them to make changes.
* Visualizer Editor: enables a user to view and modify the graph of an application network. This permission is only available in the master organization.
